...
graph LR
    ...
    frontend["<b>frontend</b><br/>:3001"]:::container
    redisCache["<b>redisCache</b>"]:::datastore
    ...
    click frontend href "https://github.com/willtsai/radius-todo-app/blob/main/app.bicep#L48" "app.bicep:48" _blank
    click redisCache href "https://github.com/willtsai/radius-todo-app/blob/main/app.bicep#L71" "app.bicep:71" _blank
